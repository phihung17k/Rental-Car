    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (option.equals("id")) {
                ...
                listOrder = orderDAO.searchOrderById(orderId);
            }else if(option.equals("date")){
                if(listOrder==null){
                    listOrder= new ArrayList<>();
                }
                String dateCreatedOrder = request.getParameter("dateCreatedOrder");
                listOrder = orderDAO.searchOrderByDate(dateCreatedOrder);
            }
            if(listOrder!=null){
...
//            e.printStackTrace();
            log("SearchOrderHistoryServlet_processRequest:"+e.getMessage());
        } finally{
